...
('Cenoura - 1kg', 449, 1),
('Ovos - dúzia', 999, 1),
('Açuçar refinado - 1kg', 549, 1),
('Chocolate em pó - 200g', 679, 1),
('Fermento quimico - 100g', 299, 1),
('Óleo de soja - 900ml', 649, 1),

-- Mercado Econômico (Loja 2)
('Feijão preto - 1kg', 749, 2),
('Arroz branco - 1kg', 579, 2),
('Farinha de mandioca - 500g', 1090, 2),
('Linguiça calabresa - 500g', 1790, 2),
('Costelinha suina - 1kg', 1890, 2),
...
('Peito de frango - 1kg', 1240, 3),
('Creme de leite - 200g', 319, 3),
('Queijo mussarela - 200g', 729, 3),
('Cenoura - 1kg', 469, 3),
('Ovos - dúzia', 1020, 3),
('Açuçar refinado - 1kg', 569, 3),
('Chocolate em pó - 200g', 699, 3),
('Fermento quimico - 100g', 319, 3);